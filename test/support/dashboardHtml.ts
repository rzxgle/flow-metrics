...
function loadDashboardHtml(): string {
  ...
  const sourceFiles = [
    ...
    path.join(root, 'frontend', 'pages', 'dependencies.ts'),
    path.join(root, 'frontend', 'pages', 'pi.ts'),
    ...
    path.join(root, 'frontend', 'ui', 'drawer.ts'),
    path.join(root, 'frontend', 'ui', 'filters.ts'),
    path.join(root, 'frontend', 'ui', 'help.ts'),
    path.join(root, 'frontend', 'ui', 'navigation.ts'),
